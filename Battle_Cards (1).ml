...
let change_gamestate gamestate player_choice=
    ...
    | (_, "Specail Offense", _, _, _) -> 
        (turn_for_enemy_player player2 (get_card h1 player_choice), 
         turn_for_current_player player1 (get_card h1 player_choice), 
         specail_card_handler_offense (get_card h1 player_choice) h2, 
         play_card h1 player_choice)
    | (_, "Specail Defense", _, _, _) -> 
        (turn_for_enemy_player player2 (get_card h1 player_choice), 
         turn_for_current_player player1 (get_card h1 player_choice), 
         h2, 
         play_card (specail_card_handler_defense (get_card h1 player_choice) h1) player_choice)
    | ("Swap hands", "Specail", _, _, _) -> 
        (turn_for_enemy_player player2 (get_card h1 player_choice), 
         turn_for_current_player player1 (get_card h1 player_choice), 
         play_card h1 player_choice, 
         h2)
